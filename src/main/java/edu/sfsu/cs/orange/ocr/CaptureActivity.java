...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private static final int OPTIONS_CONFIRM_TEXT_ID = Menu.FIRST + 3;
  private static final int OPTIONS_SHARE_TRANSLATED_TEXT_ID = Menu.FIRST + 4;

  //Custom flags/objects
  private static int confirmcount = 0;
  private ServiceAndBillingInfo dataObj = new ServiceAndBillingInfo();
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    ...
    menu.add(0, EMAIL_ID, 0, "Send Email").setIcon(android.R.drawable.ic_dialog_email);
    menu.add(0, RESET_ID, 0, "Reset").setIcon(android.R.drawable.ic_delete);
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    ...
    case SETTINGS_ID: {
      ...
      case EMAIL_ID: {
        if(dataObj != null){
          sendInfoToEmail(dataObj);
          confirmcount = 0;
          dataObj = null;
          Toast _toast = Toast.makeText(CaptureActivity.this, "Email sent", Toast.LENGTH_LONG);
          _toast.setGravity(Gravity.BOTTOM, 0, 0);
          _toast.show();
        }else{
          Toast _toast = Toast.makeText(CaptureActivity.this, "No data to be sent, reset and capture again.", Toast.LENGTH_LONG);
          _toast.setGravity(Gravity.BOTTOM, 0, 0);
          _toast.show();
        }
        break;
      ...
      case RESET_ID:{
        ...
        Toast _toast = Toast.makeText(this, "Data Reset", Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();
        break;
      }
  ...
  public void onCreateContextMenu(ContextMenu menu, View v,
    ...
    if (v.equals(ocrResultView)) {
      ...
      menu.add(Menu.NONE, OPTIONS_CONFIRM_TEXT_ID, Menu.NONE, "Confirm recognized text");
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    case OPTIONS_SHARE_RECOGNIZED_TEXT_ID:
    	...
    	return true;
    case OPTIONS_CONFIRM_TEXT_ID:

      if(dataObj == null){
        dataObj = new ServiceAndBillingInfo();
      }
      ...
      if(confirmcount == 1){
        Toast _toast = Toast.makeText(this, "1. Service ID Number: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.ServiceIDNumber = ocrResultView.getText().toString();
      }else if(confirmcount == 2){
        Toast _toast = Toast.makeText(this, "2. Rate: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.Rate = ocrResultView.getText().toString();
      }else if(confirmcount == 3){
        Toast _toast = Toast.makeText(this, "3. Contract in the name of: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.ContractInTheNameOf = ocrResultView.getText().toString();
      }else if(confirmcount == 4){
        Toast _toast = Toast.makeText(this, "4. Service Address: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.ServiceAddress = ocrResultView.getText().toString();
      }else if(confirmcount == 5){
        Toast _toast = Toast.makeText(this, "5. Bill Date:: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.BillDate = ocrResultView.getText().toString();
      }else if(confirmcount == 6){
        Toast _toast = Toast.makeText(this, "6. Meter Reading Date: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.MeterReadingDate = ocrResultView.getText().toString();
      }else if(confirmcount == 7){
        Toast _toast = Toast.makeText(this, "7. Bill Period: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.BillPeriod = ocrResultView.getText().toString();
      }else if(confirmcount == 8){
        Toast _toast = Toast.makeText(this, "8. Due Date: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.DueDate = ocrResultView.getText().toString();
      }else if(confirmcount == 9){
        Toast _toast = Toast.makeText(this, "9. Total KWH: "+ocrResultView.getText(), Toast.LENGTH_LONG);
        _toast.setGravity(Gravity.BOTTOM, 0, 0);
        _toast.show();

        dataObj.TotalKWH = ocrResultView.getText().toString();
      }
  ...
  private void sendInfoToEmail(ServiceAndBillingInfo info){
    /*if(info.ServiceIDNumber == null){
      Toast toast = Toast.makeText(this, "Service ID Number cannot be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.Rate == null){
      Toast toast = Toast.makeText(this, "Rate cannot be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.ContractInTheNameOf == null){
      Toast toast = Toast.makeText(this, "Contract in the name of cannot be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.ServiceAddress == null){
      Toast toast = Toast.makeText(this, "Service Address be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.BillDate == null){
      Toast toast = Toast.makeText(this, "Bill Date be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.MeterReadingDate == null){
      Toast toast = Toast.makeText(this, "Meter Reading Date be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.BillPeriod == null){
      Toast toast = Toast.makeText(this, "Bill Period be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.DueDate == null){
      Toast toast = Toast.makeText(this, "Due Date be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }
    if(info.TotalKWH == null){
      Toast toast = Toast.makeText(this, "TotalKWH be empty", Toast.LENGTH_LONG);
      toast.setGravity(Gravity.TOP, 0, 0);
      toast.show();
      return;
    }*/
    ...
    try {
      jsonParams.put("ServiceIDNumber", info.ServiceIDNumber);
      jsonParams.put("Rate", info.Rate);
      jsonParams.put("ContractInTheNameOf", info.ContractInTheNameOf);
      jsonParams.put("ServiceAddress", info.ServiceAddress);
      jsonParams.put("BillDate", info.BillDate);
      jsonParams.put("MeterReadingDate", info.MeterReadingDate);
      jsonParams.put("BillPeriod", info.BillPeriod);
      jsonParams.put("DueDate", info.DueDate);
      jsonParams.put("TotalKWH", info.TotalKWH);
